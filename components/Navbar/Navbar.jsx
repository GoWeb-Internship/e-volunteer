...
export const Navbar = ({slugs}) => {
  ...
  return (
    ...
    <div className="box">
      ...
      >
    <li className='w-full h-[150%] z-50 bg-headerBg flex pl-[20px] pr-[20px] justify-between items-center'>
        <Logo/>
        <Selected/>
        ...
        <li className='pb-[20px] pt-[20px] pl-[60px] items-center'>
          ...
          <button className=" mr-[21px] !h-[64px] !mb-0 !w-[194px] !mb-20px !mt-[10px] pt-[10px] pb-[10px] rounded-md bg-btnForm text-lg font-medium  text-white ">
